...
import { REQUEST_BODY_REFERENCE_PREFIX } from "../AbstractOpenAPIV3_1ParserContext";

export function getRequestBodyIdFromReference(ref: OpenAPIV3_1.ReferenceObject): string {
