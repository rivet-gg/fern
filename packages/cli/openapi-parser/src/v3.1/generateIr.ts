...
import { OpenAPIV3_1ParserContext } from "./OpenAPIV3_1ParserContext";

export function generateIr(openApi: OpenAPIV3_1.Document, taskContext: TaskContext): OpenAPIIntermediateRepresentation {
